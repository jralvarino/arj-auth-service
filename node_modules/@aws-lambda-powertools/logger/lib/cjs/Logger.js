...
const LogAttributesStore_js_1 = require("./LogAttributesStore.js");
...
class Logger extends commons_1.Utility {
     ...
     */
    #attributesStore = new LogAttributesStore_js_1.LogAttributesStore();
    /**
    ...
    createChild(options = {}) {
        ...
        const persistentKeyName = 'persistentLogAttributes' in options && !('persistentKeys' in options)
     ...
     */
    /* v8 ignore next -- @preserve */ static injectLambdaContextBefore(logger, event, context, options) {
        logger.addContext(context);
    ...
    addToPowertoolsLogData(attributes) {
        (0, commons_1.deepMerge)(this.powertoolsLogData, attributes);
    }
    ...
    #appendKeys(attributes, type) {
        ...
        if (type === 'temp') {
            ...
            this.#attributesStore.setPersistentAttributes((0, commons_1.deepMerge)(current, filtered));
        }
    }
